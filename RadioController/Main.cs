...
namespace RadioController
{
	class MainClass
	{
		public static void Main (string[] args)
		{
			...
			newstt.addMinuteTrigger (59);
			newstt.addMinuteTrigger (29);

			string basepath = "/home/apexys/content"; // @"/home/streamer/radiosoftware/content";

			Controller ctrl = new Controller(basepath + Path.DirectorySeparatorChar + "songs",basepath + Path.DirectorySeparatorChar + "jingles",basepath + Path.DirectorySeparatorChar + "news", jinglett, newstt, "http://134.245.206.50:8080/");
			ctrl.Start ();
		...
		static void interact(Controller ctrl){
			while (true) {
				...
				case "rescan":
					...
					//TODO: Retraverse Meida Directory
					ctrl.Rescan ();
